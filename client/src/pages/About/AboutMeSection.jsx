...
const aboutMeStyle =
  "px-28 pt-16 pb-10 md:pb-8 sm:pb-16 flex md:flex-col lg:flex-row gap-4 md:gap-2 sm:gap-4 justify-center sm:h-dvh sm:px-16 sm:mx-2 xs:h-vh xs:px-10 xs:gap-2 md:mb-4 2xs:px-8";
// * aboutMeTitle
