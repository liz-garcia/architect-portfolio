...
const h3Style =
  "font-light text-2xl italic h-1366-w-1024:portrait:text-3xl h-1366-w-1024:portrait:pb-2 lg:text-xl xs:text-xl sm:text-center sm:mb-1 sm:portrait:px-2 h-667-w-375:text-center h-667-w-375:text-xl h-667-w-375:portrait:px-0 3xl:text-4xl 3xl:mt-2 h-568-w-320:mb-0 h-568-w-320:text-[0.85rem]/snug h-658-w-320:text-xl xs:text-center h-658-w-320:mb-0 h-658-w-320-landscape:landscape:text-[1.15rem]/tight h-414-w-896-landscape:landscape:text-[1.35rem] h-568-w-320-landscape:landscape:mb-1 h-568-w-320-landscape:landscape:text-base/tight h-1260-w-1024:text-3xl h-1260-w-1024:pb-2";
const elevatorPitchStyle =
  "text-justify my-1 md:mb-0 sm:mb-4 lg:pb-0 2xl:pb-1 2xl:leading-relaxed sm:text-lg/relaxed h-1366-w-1024:portrait:text-xl/relaxed h-844-w-390-landscape:landscape:text-[1.05rem] h-430-w-932-landscape:landscape:text-[1.15rem] h-667-w-375:text-[1.025rem]/normal 2xs:text-base 3xl:text-2xl/relaxed 3xl:pt-4 h-658-w-320:text-[0.85rem]/tight h-658-w-320-landscape:landscape:text-[0.9rem] h-568-w-320:leading-normal h-568-w-320:mb-1 h-568-w-320-landscape:landscape:mb-2 xs-landscape:text-[0.95rem]/relaxed h-658-w-320:mb-2 h-667-w-375:mb-2 h-882-w-344:leading-relaxed xs-landscape:mt-0 h-414-w-896-landscape:landscape:text-lg/relaxed h-414-w-896:portrait:text-[1.15rem] h-412-w-915-landscape:landscape:text-[1.075rem] h-540-w-720-landscape:landscape:text-base/relaxed h-540-w-720-landscape:landscape:mt-0 h-568-w-320-landscape:landscape:mb-0 h-568-w-320-landscape:landscape:text-[0.85rem]/relaxed h-414-w-736:portrait:text-lg/relaxed h-414-w-736-landscape:landscape:text-[1.025rem]/relaxed h-375-w-812:portrait:text-lg/relaxed h-375-w-812-landscape:landscape:text-[1.045rem]/relaxed h-1260-w-1024:text-xl/relaxed h-1260-w-1024:mb-2";
const dividerStyle1 =
        ...
        <section id="aboutMe" className={aboutMeStyle}>
          ...
          <div id="aboutMeText" className={aboutMeTextStyle}>
            ...
            <div
              className={
                isSmallScreen
                  ? "flex gap-2 sm:place-content-center xs:scale-95 xs:flex-row-reverse xs:place-content-center 2xs:scale-[0.85] h-667-w-375:scale-[0.8] h-667-w-375:flex-nowrap h-658-w-320:scale-[0.65] h-844-w-390:scale-[0.85] h-882-w-344:scale-[0.8] h-568-w-320-landscape:landscape:scale-[0.85] h-568-w-320-landscape:landscape:place-content-center"
