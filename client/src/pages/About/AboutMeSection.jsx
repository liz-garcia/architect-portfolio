...
const aboutMeStyle =
  "px-28 pt-16 pb-10 md:pb-8 sm:pb-16 flex md:flex-col lg:flex-row gap-4 md:gap-2 sm:gap-4 justify-center sm:h-screen sm:px-16 sm:mx-2 xs:h-dvh xs:px-10 xs:gap-2 md:mb-4";
// * aboutMeTitle
...
const h3Style =
  "font-light text-2xl text-zinc-800 italic md:text-xl xs:text-2xl";
      ...
      <section id="aboutMe" className={aboutMeStyle}>
        ...
        <div id="aboutMeText" className={aboutMeTextStyle}>
          <h3 className={h3Style}>
            Architect, Estimator, Design <br className={brStyle} />& Drafting
          </h3>
