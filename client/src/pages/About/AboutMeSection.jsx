...
const aboutMeStyle =
  "h-fit px-28 lg:px-18 md:px-12 xl:px-16 pt-16 sm:pt-12 md:pt-8 lg:pt-10 pb-10 lg:px-12 2xl:px-16 md:pb-4 xl:pb-4 2xl:pb-5 sm:pb-16 flex lg:flex-col 2xl:flex-row gap-4 lg:gap-0 lg:gap-2 sm:gap-2 justify-center sm:h-dvh sm:px-16 sm:mx-2 xs:h-svh xs:px-10 xs:gap-2 2xs:px-8 3xl:px-32 h-658-w-320:gap-1 xs-landscape:min-h-fit xs-landscape:px-8 xs-landscape:py-4 xs-landscape:h-svh";
// * aboutMeTitle
const aboutMeTitleStyle = "lg:flex-none flex-1 w-1/3 lg:w-auto xl:w-1/5";
const h2Style =
  "font-bold font-serif text-4xl xs:text-[2.1rem] 3xl:text-6xl h-658-w-320:text-[1.8rem] h-568-w-320-landscape:text-3xl";
// * aboutMeText
...
const elevatorPitchStyle =
  "text-justify my-1 md:mb-0 sm:mb-4 lg:pb-0 2xl:pb-1 2xl:leading-relaxed h-667-w-375:text-base 2xs:text-base 3xl:text-2xl/relaxed 3xl:pt-4 h-658-w-320:text-sm/relaxed h-568-w-320:leading-normal h-568-w-320:mb-1 xs-landscape:text-sm/relaxed";
const dividerStyle1 =
