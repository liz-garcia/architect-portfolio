...
const aboutMeContainer =
  "3xl:h-1/2 3xl:flex 3xl:flex-col 3xl:items-center 3xl:justify-center";
const aboutMeStyle =
...
const h3Style =
  "font-light text-2xl text-zinc-800 italic md:text-xl xs:text-2xl sm:mb-1 h-667-w-375:text-xl 3xl:text-4xl 3xl:mt-2";
