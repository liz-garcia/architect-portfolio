...
const h2Style =
  "font-bold font-serif text-4xl xs:text-[2.1rem] 3xl:text-6xl h-658-w-320:text-3xl h-568-w-320-landscape:text-3xl h-667-w-375:text-center h-667-w-375:pt-2 xs:text-center";
// * aboutMeText
...
const h3Style =
  "font-light text-2xl text-zinc-800 italic lg:text-xl xs:text-2xl sm:mb-1 h-667-w-375:text-center h-667-w-375:text-2xl 3xl:text-4xl 3xl:mt-2 h-568-w-320:mb-0 h-568-w-320:text-[0.9rem] h-658-w-320:text-xl xs:text-center h-658-w-320:mb-0";
const elevatorPitchStyle =
  "text-justify my-1 md:mb-0 sm:mb-4 lg:pb-0 2xl:pb-1 2xl:leading-relaxed h-667-w-375:text-base 2xs:text-base 3xl:text-2xl/relaxed 3xl:pt-4 h-658-w-320:text-sm/relaxed h-568-w-320:leading-normal h-568-w-320:mb-1 xs-landscape:text-sm/relaxed h-658-w-320:mb-2 h-667-w-375:mb-2 h-882-w-344:leading-relaxed";
const dividerStyle1 =
