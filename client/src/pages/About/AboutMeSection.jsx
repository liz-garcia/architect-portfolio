...
const aboutMeTextStyle =
  "lg:flex-none flex flex-col gap-1 w-2/3 lg:w-auto pt-2 pl-4 pr-18 lg:pl-0 sm:pt-0 3xl:pl-16 xl:w-4/5 3xl:w-4/5 xs-landscape:pt-0 h-540-w-720-landscape:landscape:pt-1";
const h3Style =
...
const elevatorPitchStyle =
  "text-justify my-1 md:mb-0 sm:mb-4 lg:pb-0 2xl:pb-1 2xl:leading-relaxed h-844-w-390-landscape:landscape:text-[1.05rem] h-430-w-932-landscape:landscape:text-[1.15rem] h-667-w-375:text-base 2xs:text-base 3xl:text-2xl/relaxed 3xl:pt-4 h-658-w-320:text-[0.9rem] h-658-w-320-landscape:landscape:text-[0.9rem] h-568-w-320:leading-normal h-568-w-320:mb-1 xs-landscape:text-[0.95rem]/relaxed h-658-w-320:mb-2 h-667-w-375:mb-2 h-882-w-344:leading-relaxed xs-landscape:mt-0 h-414-w-896-landscape:landscape:text-lg/relaxed h-414-w-896:portrait:text-[1.15rem] h-412-w-915-landscape:landscape:text-[1.15rem] h-540-w-720-landscape:landscape:text-base/relaxed h-540-w-720-landscape:landscape:mt-0";
const dividerStyle1 =
