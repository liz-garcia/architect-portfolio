...
const h3Style =
  "font-light text-2xl text-zinc-800 italic h-1366-w-1024:portrait:text-3xl h-1366-w-1024:portrait:pb-2 lg:text-xl xs:text-2xl sm:text-center sm:mb-1 sm:portrait:px-2 h-667-w-375:text-center h-667-w-375:text-xl h-667-w-375:portrait:px-0 3xl:text-4xl 3xl:mt-2 h-568-w-320:mb-0 h-568-w-320:text-[1.05rem]/snug h-658-w-320:text-xl xs:text-center h-658-w-320:mb-0 h-658-w-320-landscape:landscape:text-[1.15rem]/tight h-414-w-896-landscape:landscape:text-[1.45rem] h-568-w-320-landscape:landscape:mb-1 h-568-w-320-landscape:landscape:text-base/tight h-1260-w-1024:text-3xl h-1260-w-1024:pb-2";
