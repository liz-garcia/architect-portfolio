...
const aboutMeStyle =
  "px-28 pt-16 pb-10 md:pb-8 sm:pb-16 flex md:flex-col lg:flex-row gap-4 md:gap-2 sm:gap-4 justify-center sm:h-screen sm:px-16 sm:mx-2 xs:h-dvh xs:px-10 xs:gap-2 md:mb-4 2xs:px-8";
// * aboutMeTitle
...
const h3Style =
  "font-light text-2xl text-zinc-800 italic md:text-xl xs:text-2xl sm:mb-1";
// const brStyle = "3xl:hidden 2xl:hidden xs:block";
const elevatorPitchStyle = "text-justify my-1 sm:mb-4 2xs:text-base";
const dividerStyle1 =
