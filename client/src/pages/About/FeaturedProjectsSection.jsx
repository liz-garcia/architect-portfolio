...
const imageContainerStyle =
  "flex items-center justify-center animate-fadeInUp min-h-[40px] overflow-hidden h-540-w-720-landscape:landscape:w-[27.5vw] 3xl:w-4/12 lg:w-3/12 2xl:w-4/12 mb-2 rounded-xl 3xl:rounded-2xl sm:size-full lg-md-portrait:w-4/12 lg-md-portrait:h-full xs-landscape:h-[80vh] drop-shadow";
const transition =
  "hover:bg-sky-200 hover:border hover:border-sky-400 hover:cursor-pointer hover:scale-105 transform transition ease-in-out duration-500";
