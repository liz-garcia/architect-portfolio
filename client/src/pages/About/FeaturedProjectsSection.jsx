...
const imageContainerStyle =
  "animate-fadeInUp min-h-[40px] h-540-w-720-landscape:landscape:w-[27.5vw] 3xl:w-4/12 lg:w-3/12 2xl:w-4/12 mb-2 rounded-xl 3xl:rounded-2xl overflow-hidden sm:size-full lg-md-portrait:w-4/12 lg-md-portrait:h-full xs-landscape:h-[80vh]";
const transition =
    ...
    <section id="featuredProjects" className={featuredProjectsStyle}>
      <div className={projectContainerStyle}>
        <Image
          ...
          altText="Project 1"
          objectFit="cover"
          objectExtra="object-right-bottom sm:object-left-bottom xs:object-right-bottom"
        />
      </div>
      <div className={projectContainerStyle}>
