    ...
    <section id="featuredProjects" className={featuredProjectsStyle}>
      <div className={projectContainerStyle}>
        <Image
          ...
          altText="Project 1"
          objectFit="cover"
          objectExtra="object-right-bottom sm:object-left-bottom xs:object-right-bottom hover:opacity-15 z-40"
        />
        <p className="absolute z-10 transform place-self-center text-lg text-zinc-950 transition duration-500 ease-in-out">
          Title Project 1
        </p>
      </div>
      <div className={projectContainerStyle}>
        <Image
          ...
          altText="Project 2"
          objectFit="cover"
          objectExtra="hover:opacity-15 z-40"
        />
        <p className="absolute z-10 transform place-self-center text-lg text-zinc-950 transition duration-500 ease-in-out">
          Title Project 2
        </p>
      ...
      <div className={projectContainerStyle}>
        <Image
          ...
          altText="Project 3"
          objectFit="cover"
          objectExtra="object-bottom hover:opacity-15 z-40"
        />
        <p className="absolute z-10 transform place-self-center text-lg text-zinc-950 transition duration-500 ease-in-out">
          Title Project 3
        </p>
