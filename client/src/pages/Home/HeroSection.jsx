...
const heroSectionStyle =
  "w-[100dvw] h-[88dvh] flex pl-16 md:p-0 md:pb-1 2xl:pl-16 3xl:pl-28 items-center justify-center md:flex-col-reverse gap-8 md:gap-3 2xl:gap-12 3xl:gap-24 xs:gap-0 xs:h-[84svh] xs-landscape:flex-row xs-landscape:h-[84svh] h-1366-w-1024:flex-col-reverse h-1366-w-1024:gap-3 h-1366-w-1024:p-0 h-1366-w-1024:pb-2";
const heroTitleStyle =
  "w-1/3 text-center flex flex-col md:w-full md:h-1/3 sm:h-2/5 items-center justify-center md:pb-8 sm:pb-6 xs:pb-4 xs:h-[40%] xs:pl-1 xs-landscape:scale-90 h-658-w-320-landscape:min-h-fit h-568-w-320-landscape:min-h-fit h-1366-w-1024:w-full h-1366-w-1024:h-1/3 h-1366-w-1024:pb-8";
const h1Style =
...
const heroButtonsStyle =
  "flex gap-2 3xl:gap-4 h-568-w-320-landscape:scale-90 h-667-w-375-landscape:scale-90 h-1366-w-1024:scale-105 h-568-w-320:scale-[0.85] h-658-w-320:scale-[0.85] h-667-w-375:scale-[0.85] lg-portrait:scale-[1.10]]";
