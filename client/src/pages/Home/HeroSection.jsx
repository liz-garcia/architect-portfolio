...
const heroSectionStyle =
  "w-[100dvw] h-[88dvh] flex pl-16 md:p-0 2xl:pl-16 3xl:pl-28 items-center justify-center md:flex-col-reverse gap-8 md:gap-3 2xl:gap-12 3xl:gap-24 xs:gap-0 xs:h-[88dvh]";
const heroTitleStyle =
  "w-1/3 text-center flex flex-col md:w-full md:h-1/3 sm:h-2/5 items-center justify-center md:pb-8 sm:pb-12 xs:pb-0 xs:h-[30%]";
const h1Style =
...
const heroImagesContainerStyle =
  "w-2/3 h-full md:h-2/3 sm:h-3/5 md:w-full xs:h-[70%]";
