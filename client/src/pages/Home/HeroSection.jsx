...
const h1Style =
  "font-serif italic font-bold mb-4 sm:text-[3.25rem]/[2.5rem] lg:text-6xl/[3.5rem] xl:text-7xl/[4rem] 2xl:text-[5.5rem]/[4.5rem] 3xl:text-9xl/[6.5rem] md:mb-2 sm:mb-0 sm:pb-0 sm:pt-2 xs:text-[2.75rem]/[2.15rem] 2xs:text-4xl/[2rem]";
const h2Style =
