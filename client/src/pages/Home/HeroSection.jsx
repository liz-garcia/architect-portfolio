...
const heroImagesContainerStyle =
  "animate-fadeInUp w-2/3 h-full md:h-2/3 md-landscape:h-1/2 sm:h-3/5 md:w-full xs:h-[60%] xs-landscape:h-[100%] h-1366-w-1024:w-full h-1366-w-1024:h-2/3";
