...
const heroTitleStyle =
  "w-1/3 text-center flex flex-col md:w-full md:h-1/3 sm:h-2/5 items-center justify-center md:pb-8 sm:pb-12 xs:pb-0 xs:h-[40%]";
const h1Style =
  "font-serif italic font-bold mb-4 sm:text-5xl/[2.5rem] lg:text-5xl/[3rem] xl:text-6xl/[3.5rem] 2xl:text-7xl/[4rem] 3xl:text-8xl/[5.5rem] md:mb-2 sm:pb-0 sm:pt-2 xs:text-4xl/[2rem]";
const h2Style =
