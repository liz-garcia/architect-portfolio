...
const heroTitleStyle =
  "w-1/3 text-center flex flex-col md:w-full md:h-1/3 items-center justify-center md:pb-8 sm:pb-5";
const h1Style =
  "font-serif font-bold mb-4 lg:text-5xl/[3rem] xl:text-6xl/[3.5rem] 2xl:text-7xl/[4rem] 3xl:text-8xl/[5.5rem] md:mb-2 sm:pb-1";
const h2Style =
