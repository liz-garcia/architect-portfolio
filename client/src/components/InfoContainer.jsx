...
const itemTitle =
  "inline bg-lime-100 w-fit px-1 py-0 font-semibold 3xl:text-2xl lg:portrait:text-lg md:portrait:text-base xs:portrait:text-lg 2xs:portrait:text-base h-568-w-320-landscape:text-sm";
const itemDetail =
