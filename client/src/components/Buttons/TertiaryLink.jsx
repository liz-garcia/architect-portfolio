...
const font = "font-normal text-zinc-700 text-center uppercase text-sm";
const layout = "block px-5 py-3";
const hoverFont =
  "hover:text-zinc-700 hover:font-normal hover:text-sm hover:underline underline-offset-8";
