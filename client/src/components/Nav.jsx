...
const linkStyle =
  "uppercase font-normal size-full flex items-center justify-center text-center hover:underline underline-offset-8 text-sm xs:text-base h-1366-w-1024:text-base xs:p-1 3xl:text-xl h-568-w-320:pt-0";
